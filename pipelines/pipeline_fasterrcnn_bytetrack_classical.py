"""
Plik: pipelines/pipeline_fasterrcnn_bytetrack_classical.py
...
# KONFIGURACJA
# ==========================================================================
RUN_NAME = "pipeline_frcnn_bt_classical"
...
def run_pipeline():
    ...
    if FRCNN_WEIGHTS.exists():
        print(f"[2/6] Ladowanie Faster R-CNN (fine-tuned): {FRCNN_WEIGHTS}")
        detector = FasterRCNNDetector(weights_path=str(FRCNN_WEIGHTS), conf_threshold=CONF_THRESHOLD)
    else:
        ...
        detector = FasterRCNNDetector(weights_path=None, conf_threshold=CONF_THRESHOLD)
