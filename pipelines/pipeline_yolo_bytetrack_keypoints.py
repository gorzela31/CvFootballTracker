...
# KONFIGURACJA
# ==========================================================================
RUN_NAME = "pipeline_yolo_bt_keypoints"
...
def run_pipeline():
    ...
    print(f"[3/6] Inicjalizacja KeypointsHomography (obrazy {w}x{h})")
        ...
        if frame_idx % CALIB_STRIDE == 0:
            ...
            if new_H is not None:
                ...
                raise RuntimeError(
                    ...
                    "Sprawdz wagi modelu keypoints oraz czy klatka zawiera widoczne linie boiska."
                )
            else:
